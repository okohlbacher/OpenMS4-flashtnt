...
protected:
  ...
  void registerOptionsAndFlags_() override
  {
    ...
    registerStringList_("ion_type", "Specifies ion types to consider.", StringList{"b", "y"}, "Specifies ion types to consider.", false);
  ...
  ExitCodes main_(int, const char**) override
  {
    ...
    std::string in_fasta = getStringOption_("fasta");

    std::string out_tag_file = getStringOption_("out_tag");
    std::string out_prsm_file = getStringOption_("out_prsm");
    std::string out_pro_file = getStringOption_("out_pro");
